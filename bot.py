...
def words_to_article(text: str) -> str:
    ...
    """
    Преобразует русские названия букв в латиницу.
    Например:
    'эс эм ноль четыре три ноль ноль' → 'sm04300'
    """
...
async def voice_handler(message: Message):
    ...
    text = words_to_latin_letters(text)
